...
/*<visibility>*/public/*</visibility>*/ class /*<name>*/FBSDKUtility/*</name>*/ 
    ...
    public static native NSDictionary<NSString, NSString> getDictionary(String queryString);
    public static String queryString(NSDictionary<NSString, ?> dictionary) throws NSErrorException {
       NSError.NSErrorPtr ptr = new NSError.NSErrorPtr();
       String result = queryString(dictionary, ptr);
       if (ptr.get() != null) { throw new NSErrorException(ptr.get()); }
       return result;
    }
    @Method(selector = "queryStringWithDictionary:error:")
    private static native String queryString(NSDictionary<NSString, ?> dictionary, NSError.NSErrorPtr errorRef);
